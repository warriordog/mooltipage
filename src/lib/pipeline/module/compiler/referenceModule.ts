...
import { MFragmentNode, DocumentNode, Fragment, FragmentContext, NodeWithChildren, Node, MContentNode } from '../../..';
...
export class ReferenceModule implements HtmlCompilerModule {
    ...
    private replaceReference(refNode: MFragmentNode, htmlContext: HtmlCompilerContext): void {
        // get slot contents
        ...
        const refContents: Fragment = htmlContext.pipelineContext.pipeline.compileFragment(refNode.src, fragmentContext);
