...
export interface PipelineCache {
     ...
     */
    readonly fragmentCache: Cache<string, Fragment>;
     ...
     */
    readonly expressionCache: Cache<string, EvalFunction<unknown>>;
     ...
     * If fuzzy / equivalent matching is needed, then the caller is responsible for pre-processing the key.
     */
    readonly scriptCache: Cache<string, EvalFunction<unknown>>;
     ...
     */
    readonly createdResourceCache: Cache<string, string>;
